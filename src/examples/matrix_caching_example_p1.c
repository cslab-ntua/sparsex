...
/**
 * \file matrix_caching_example_p1.c
 * \brief Read matrix from MMF file, tune it into the CSX format and save it
 *        in a binary file for a future session.
 *
...
void print_usage()
{
  fprintf(stderr, "Usage: %s <mmf_file> <binary_file>\n", program_name);
}
