...
//             oa << csx->nnz & csx->ncols & csx->nrows & csx->ctl_size
//                 & csx->row_start;
//             // for (size_t i=0;i<csx->ctl_size;i++)
//             //     printf("%"PRIu8" ", csx->ctl[i]);
//             // std::cout << std::endl;
//             oa << boost::serialization::make_array(csx->values, csx->nnz);
//             oa << boost::serialization::make_array(csx->ctl, csx->ctl_size);
//             oa << csx->id_map & csx->row_jumps;
//             oa << boost::serialization::make_array(csx->rows_info, csx->nrows);
//             // std::cout << csx->rows_info->rowptr << " " << csx->rows_info->valptr << " " << csx->rows_info->span << std::endl;
//             // std::cout << csx->nrows << " " << csx->ncols << " " << csx->nnz << std::endl;
//             // std::cout << csx->row_start << " " << csx->ctl_size << std::endl;
//             // std::cout << csx->id_map[0] << std::endl;
//             if (spm_mt->symmetric) {
...
//         spm_mt->spm_threads = (spm_mt_thread_t *) malloc
...
//         size_t *ctl_parts = (size_t *) malloc(sizeof(*ctl_parts) * nr_threads);
//         size_t *val_parts = (size_t *) malloc(sizeof(*val_parts) * nr_threads);
//         int *ctl_nodes = (int *) malloc(sizeof(*ctl_nodes) * nr_threads);
//         int *val_nodes = (int *) malloc(sizeof(*val_nodes) * nr_threads);
//         if (!ctl_parts || !ctl_nodes || !val_parts || !val_nodes) {
//             LOG_ERROR << "malloc failed\n";
//             exit(1);
//         }
...
// #endif    
//             csx->rows_info = (row_info_t *) malloc
//                 (sizeof(row_info_t) * csx->nrows);
//             if (!csx->values || !csx->ctl || !csx->rows_info) {
//                 LOG_ERROR << "malloc failed\n";
//                 exit(1);
//             }
...
//                 map->cpus = (unsigned int *) malloc(length * sizeof(unsigned int));
//                 map->elems_pos = 
