/* -*- C++ -*-
 *
 * MatrixLoading.hpp --  Functions for loading sparse matrices from
 ...
 */
#ifndef MATRIX_LOADING_HPP
#define MATRIX_LOADING_HPP
                                                         ...
                                                         const long nr)
{
    ...
    ret = SparsePartitionSym<IndexType, ValueType>::DoLoadMatrix(mmf, nr);
    return ret;
}
