...
double vec_mul_part(const vector_t *v1, const vector_t *v2, unsigned long start,
                    unsigned long end);
...
vector_t *vec_reorder(const vector_t *v, int *p);
vector_t *vec_inv_reorder(const vector_t *v, int *p);
