/* -*- C++ -*-
 *
 * sparse_partition.h --  Internal representation of sparse matrice partition.
 *
 ...
 */
#ifndef CSX_SPARSE_PARTITION_H__
#define CSX_SPARSE_PARTITION_H__
...
public:
     ...
     */
    Builder(SparsePartition *sp, IndexType nr_rows = 0,
