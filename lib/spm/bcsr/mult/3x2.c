/*
 * bcsr/mult/3x2.c -- BCSR 3x2 multiplication method
 *
...
void SPM_BCSR_NAME(_multiply_3x2)(void *spm, VECTOR_TYPE *in, VECTOR_TYPE *out)
{
	...
	for (i = r_start, i_ = r_start / 3; i < r_end; i += 3, i_++) {
		register ELEM_TYPE yr0 = 0;
		register ELEM_TYPE yr1 = 0;
		register ELEM_TYPE yr2 = 0;
		for (j = brow_ptr[i_], j_ = j / (3*2);
		     j < brow_ptr[i_+1]; j += 3*2, j_++) {
...
void SPM_BCSR_MT_NAME(_multiply_3x2)(void *spm, VECTOR_TYPE *in, VECTOR_TYPE *out)
{
