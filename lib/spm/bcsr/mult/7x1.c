/*
 * bcsr/mult/7x1.c -- BCSR 7x1 multiplication method
 *
...
void SPM_BCSR_NAME(_multiply_7x1) (void *spm, VECTOR_TYPE *in, VECTOR_TYPE *out)
{
    ...
    for (i = r_start, i_ = r_start / 7; i < r_end; i += 7, i_++) {
        ...
        for (j = brow_ptr[i_], j_ = j / (7*1);
             j < brow_ptr[i_+1]; j += 7*1, j_++) {
...
void SPM_BCSR_MT_NAME(_multiply_7x1) (void *spm, VECTOR_TYPE *in, VECTOR_TYPE *out)
{
