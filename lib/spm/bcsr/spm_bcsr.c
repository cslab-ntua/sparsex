...
static void _scan_csr(const SPM_CRS_TYPE *mat, SPM_CRS_IDX_TYPE r, SPM_CRS_IDX_TYPE c,
                               ...
                               uint64_t *nrows, uint64_t *ncols, uint64_t *nnz, void *metadata)
{
    ...
    SPM_BCSR_TYPE *bcsr = SPM_BCSR_NAME(_init_crs)(crs, meta->br, meta->bc,
...
SPM_BCSR_TYPE *SPM_BCSR_NAME(_init_crs)(const SPM_CRS_TYPE *crs, uint64_t r, uint64_t c,
                                        uint64_t pad)
{
 ...
 */ 
static void
_fill_bcsr(SPM_BCSR_TYPE *mat, const SPM_CRS_TYPE *matin, SPM_CRS_IDX_TYPE max_pad,
           SPM_CRS_TYPE *leftover, block_cache_t *blk_cache)
{
    SPM_CRS_IDX_TYPE    i, j, k;
    spm_elem_t curr_elem;
