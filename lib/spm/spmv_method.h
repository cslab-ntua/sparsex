...
typedef void spmv_double_fn_t(void *matrix, vector_double_t *in,
                              vector_double_t *out);
typedef void spmv_float_fn_t(void *matrix, vector_float_t *in,
                             vector_float_t *out);
typedef void spmv_double_sym_fn_t(void *matrix, vector_double_t *in,
                                  vector_double_t *out, vector_double_t *temp);
typedef void spmv_float_sym_fn_t(void *matrix, vector_float_t *in,
                                 vector_float_t *out, vector_float_t *temp);
typedef void *spm_load_fn_t(char *mmf, uint64_t *nrows, uint64_t *ncols,
...
#define SPMV_METH_INIT(fn, _mmf_init, _size, _destroy, _elem_size) \
    static spmv_method_t _spmv_meth_ ## fn =                            \
        _SPMV_METH_INIT(_mmf_init, _size, _destroy, _elem_size); \
...
#define SPMV_MT_METH_INIT(fn, _mmf_init, _size, _destroy, _elem_size) \
    static spmv_method_t _spmv_mt_meth_ ## fn =                       \
        _SPMV_MT_METH_INIT(_mmf_init, _size, _destroy, _elem_size);   \
...
#define SPMV_SYM_METH_INIT(fn, _mmf_init, _size, _destroy, _elem_size) \
    static spmv_method_t _spmv_meth_ ## fn =                           \
        _SPMV_SYM_METH_INIT(_mmf_init, _size, _destroy, _elem_size);   \
    METHOD_INIT(fn, &_spmv_meth_ ## fn)
...
#define SPMV_SYM_MT_METH_INIT(fn, _mmf_init, _size, _destroy, _elem_size) \
    static spmv_method_t _spmv_mt_meth_ ## fn =                         \
        _SPMV_SYM_MT_METH_INIT(_mmf_init, _size, _destroy, _elem_size); \
    METHOD_INIT(fn, &_spmv_mt_meth_ ## fn)
