...
float spmv_double_bench_kernel_mt(spm_mt_t *spm_mt, unsigned long loops, 
                                  unsigned long nrows, unsigned long ncols,
                                  double alpha, double beta,
                                  spmv_double_fn_t *fn);
float spmv_float_bench_kernel_mt(spm_mt_t *spm_mt, unsigned long loops, 
                                 unsigned long nrows, unsigned long ncols,
...
void spmv_float_check_mt_loop(void *spm, spm_mt_t *spm_mt, spmv_float_fn_t *fn,
                              unsigned long loops, unsigned long rows_nr,
                              unsigned long cols_nr, spmv_float_fn_t *mt_fn);
