...
namespace sparsex {
  namespace csx {
    ...
    /**
     *  Returns the value of the corresponding element (0 if element doesn't 
     *  exist). Indexes row/col are assumed to be 1-based.
     */
    template<typename IndexType, typename ValueType>
    bool GetValueCsx(void *spm, IndexType row, IndexType col, ValueType *value);
    template<typename IndexType, typename ValueType>
    bool GetValueCsxSym(void *spm, IndexType row, IndexType col,
			ValueType *value);
    ...
    template<typename IndexType, typename ValueType>
    bool SetValueCsxSym(void *spm, IndexType row, IndexType col,
			ValueType value);
