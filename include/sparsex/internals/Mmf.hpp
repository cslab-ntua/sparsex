...
namespace sparsex {
  namespace io {
    ...
    template<typename IndexType, typename ValueType>
    typename MMF<IndexType, ValueType>::iterator MMF<IndexType, ValueType>::
    begin()
    {
     ...
     */
    template<typename IndexType, typename ValueType>
    boost::unordered_map<typename MMF<IndexType, ValueType>::MmfInfo,
			 const string>
    ...
    template<typename IndexType, typename ValueType>
    void MMF<IndexType, ValueType>::
    ParseMmfHeaderLine(vector<string> &arguments)
    {
    ...
    template<typename IndexType, typename ValueType>
    void MMF<IndexType, ValueType>::
    ParseMmfSizeLine(vector<string> &arguments)
    {
    ...
    template<typename IndexType, typename ValueType>
    bool MMF<IndexType, ValueType>::
    GetNext(IndexType &r, IndexType &c, ValueType &v)
    {
      vector<string> arguments;
